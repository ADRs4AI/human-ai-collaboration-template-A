...
- **Crew coordination layer** (`justfile`, `scripts/`, `docs/inbox/`) — per **meta-repo ADR-0003**, backported from the layer's operational proving grounds (caring-form crews → ADRs4AI meta repo, the most-fixed lineage).
